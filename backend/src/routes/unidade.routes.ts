...
routes.post('/add-avaliacao/:unidade_id', Authentication(), new UnidadeController().addAvaliacao)
routes.put('/update-avaliacao/:avaliacao_id', Authentication(), new UnidadeController().updateAvaliacao)
routes.delete('/delete-avaliacao/:avaliacao_id', Authentication(), new UnidadeController().deleteAvaliacao)
routes.get('/get-avaliacoes/:unidade_id', Authentication(), new UnidadeController().getAvaliacoes)
